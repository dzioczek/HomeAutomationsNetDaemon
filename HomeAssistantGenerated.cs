//------------------------------------------------------------------------------
// <auto-generated>
// Generated using NetDaemon CodeGenerator nd-codegen v24.35.1.0
//   At: 2024-09-04T11:35:06.7191580+02:00
//
...
public partial class SensorEntities
{
    ...
    ///<summary>0x5c0272fffe80807c Action</summary>
    public SensorEntity _0x5c0272fffe80807cAction => new(_haContext, "sensor.0x5c0272fffe80807c_action");
    ///<summary>0x5c0272fffe80807c Click</summary>
    public SensorEntity _0x5c0272fffe80807cClick => new(_haContext, "sensor.0x5c0272fffe80807c_click");
    ...
    public SensorEntity Prusamk4 => new(_haContext, "sensor.prusamk4");
    public SensorEntity Prusamk42 => new(_haContext, "sensor.prusamk4_2");
    ///<summary>Filename</summary>
    public SensorEntity Prusamk4Filename => new(_haContext, "sensor.prusamk4_filename");
    ///<summary>Filename</summary>
    public SensorEntity Prusamk4Filename2 => new(_haContext, "sensor.prusamk4_filename_2");
    ///<summary>Material</summary>
    public SensorEntity Prusamk4Material => new(_haContext, "sensor.prusamk4_material");
    ///<summary>Material</summary>
    public SensorEntity Prusamk4Material2 => new(_haContext, "sensor.prusamk4_material_2");
    ///<summary>Print finish</summary>
    public SensorEntity Prusamk4PrintFinish => new(_haContext, "sensor.prusamk4_print_finish");
    ///<summary>Print finish</summary>
    public SensorEntity Prusamk4PrintFinish2 => new(_haContext, "sensor.prusamk4_print_finish_2");
    ///<summary>Print start</summary>
    public SensorEntity Prusamk4PrintStart => new(_haContext, "sensor.prusamk4_print_start");
    ///<summary>Print start</summary>
    ...
    ///<summary>0x5c0272fffe80807c Battery</summary>
    public NumericSensorEntity _0x5c0272fffe80807cBattery => new(_haContext, "sensor.0x5c0272fffe80807c_battery");
    ...
    ///<summary>Print speed</summary>
    public NumericSensorEntity Prusamk4PrintSpeed => new(_haContext, "sensor.prusamk4_print_speed");
    ///<summary>Print speed</summary>
    public NumericSensorEntity Prusamk4PrintSpeed2 => new(_haContext, "sensor.prusamk4_print_speed_2");
    ///<summary>Progress</summary>
    public NumericSensorEntity Prusamk4Progress => new(_haContext, "sensor.prusamk4_progress");
    ///<summary>Progress</summary>
    ...
    ///<summary>temp_master_bedroom Battery</summary>
    public NumericSensorEntity TempMasterBedroomBattery => new(_haContext, "sensor.temp_master_bedroom_battery");
    ///<summary>temp_master_bedroom Humidity</summary>
    public NumericSensorEntity TempMasterBedroomHumidity => new(_haContext, "sensor.temp_master_bedroom_humidity");
    ///<summary>temp_master_bedroom Atmospheric pressure</summary>
    public NumericSensorEntity TempMasterBedroomPressure => new(_haContext, "sensor.temp_master_bedroom_pressure");
    ///<summary>temp_master_bedroom Temperature</summary>
    public NumericSensorEntity TempMasterBedroomTemperature => new(_haContext, "sensor.temp_master_bedroom_temperature");
...
public partial class UpdateEntities
{
    ...
    ///<summary>0x5c0272fffe80807c</summary>
    public UpdateEntity _0x5c0272fffe80807c => new(_haContext, "update.0x5c0272fffe80807c");
    ///<summary>blind_office</summary>
...
public partial class ButtonEntities
{
    ...
    public ButtonEntity Prusamk4CancelJob => new(_haContext, "button.prusamk4_cancel_job");
    ///<summary>Cancel job</summary>
    public ButtonEntity Prusamk4CancelJob2 => new(_haContext, "button.prusamk4_cancel_job_2");
    ///<summary>Pause job</summary>
    public ButtonEntity Prusamk4PauseJob => new(_haContext, "button.prusamk4_pause_job");
    ///<summary>Pause job</summary>
    public ButtonEntity Prusamk4PauseJob2 => new(_haContext, "button.prusamk4_pause_job_2");
    ///<summary>Resume job</summary>
    public ButtonEntity Prusamk4ResumeJob => new(_haContext, "button.prusamk4_resume_job");
    ///<summary>Resume job</summary>
...
public partial class CameraEntities
{
    ...
    public CameraEntity Prusamk4Preview => new(_haContext, "camera.prusamk4_preview");
    ///<summary>Preview</summary>
...
public partial class LightServices
{
    ...
    public void Toggle(ServiceTarget target, double? transition = null, IReadOnlyCollection<int>? rgbColor = null, object? colorName = null, object? hsColor = null, object? xyColor = null, object? colorTemp = null, object? kelvin = null, double? brightness = null, double? brightnessPct = null, object? white = null, string? profile = null, object? flash = null, string? effect = null)
    {
    ...
    ///<param name="flash">Tell light to flash, can be either value short or long.</param>
    ///<param name="effect">Light effect.</param>
    public void TurnOn(ServiceTarget target, double? transition = null, IReadOnlyCollection<int>? rgbColor = null, object? rgbwColor = null, object? rgbwwColor = null, object? colorName = null, object? hsColor = null, object? xyColor = null, object? colorTemp = null, object? kelvin = null, double? brightness = null, double? brightnessPct = null, double? brightnessStep = null, double? brightnessStepPct = null, object? white = null, string? profile = null, object? flash = null, string? effect = null)
    {
...
public partial class NotifyServices
{
    ...
    ///<summary>Sends a notification message using the mobile_app_greencell integration.</summary>
    public void MobileAppGreencell(NotifyMobileAppGreencellParameters data)
    {
        _haContext.CallService("notify", "mobile_app_greencell", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void MobileAppGreencell(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_greencell", null, new NotifyMobileAppGreencellParameters { Message = message, Title = title, Target = target, Data = data });
    }
...
public partial record NotifyMobileAppGreencellParameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
