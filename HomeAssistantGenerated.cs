...
//   At: 2024-10-29T21:36:42.2813790+01:00
//
...
public partial class SelectEntities
{
    ...
    ///<summary>bulb_master_bed Power-on behavior</summary>
    public SelectEntity BulbMasterBedPowerOnBehavior => new(_haContext, "select.bulb_master_bed_power_on_behavior");
    ///<summary>plug_ender Power-on behavior</summary>
    public SelectEntity PlugEnderPowerOnBehavior => new(_haContext, "select.plug_ender_power_on_behavior");
    ///<summary>plug_hot_water_pump Power-on behavior</summary>
    public SelectEntity PlugHotWaterPumpPowerOnBehavior => new(_haContext, "select.plug_hot_water_pump_power_on_behavior");
    ///<summary>plug_upstairs_bathroom_fan Power-on behavior</summary>
    ...
    ///<summary>switch_staircase_lights Power-on behavior</summary>
...
public partial class SensorEntities
{
    ...
    ///<summary>blind_office Motor state</summary>
    public SensorEntity BlindOfficeMotorState => new(_haContext, "sensor.blind_office_motor_state");
    ///<summary>bulb_master_bed Color options</summary>
    public SensorEntity BulbMasterBedColorOptions => new(_haContext, "sensor.bulb_master_bed_color_options");
    ...
    ///<summary>greenCell App Version</summary>
    public SensorEntity GreencellAppVersion => new(_haContext, "sensor.greencell_app_version");
    ///<summary>greenCell Location permission</summary>
    public SensorEntity GreencellLocationPermission => new(_haContext, "sensor.greencell_location_permission");
    ///<summary>greenCell Watch Battery State</summary>
    public SensorEntity GreencellWatchBatteryState => new(_haContext, "sensor.greencell_watch_battery_state");
    ...
    ///<summary>iPhone (Natalia) App Version</summary>
    public SensorEntity IphoneNataliaAppVersion => new(_haContext, "sensor.iphone_natalia_app_version");
    ...
    ///<summary>iPhone (Natalia) Location permission</summary>
    public SensorEntity IphoneNataliaLocationPermission => new(_haContext, "sensor.iphone_natalia_location_permission");
    ...
    ///<summary>iPhone (Natalia) Watch Battery State</summary>
    public SensorEntity IphoneNataliaWatchBatteryState => new(_haContext, "sensor.iphone_natalia_watch_battery_state");
    ...
    ///<summary>PrusaMK4</summary>
    public SensorEntity Prusamk42 => new(_haContext, "sensor.prusamk4_2");
    ///<summary>PrusaMK4 Filename</summary>
    public SensorEntity Prusamk4Filename2 => new(_haContext, "sensor.prusamk4_filename_2");
    ///<summary>PrusaMK4 Material</summary>
    public SensorEntity Prusamk4Material2 => new(_haContext, "sensor.prusamk4_material_2");
    ///<summary>PrusaMK4 Print finish</summary>
    public SensorEntity Prusamk4PrintFinish2 => new(_haContext, "sensor.prusamk4_print_finish_2");
    ///<summary>PrusaMK4 Print start</summary>
    public SensorEntity Prusamk4PrintStart2 => new(_haContext, "sensor.prusamk4_print_start_2");
    ...
    ///<summary>switch_ikea_master_bedroom Action</summary>
    public SensorEntity SwitchIkeaMasterBedroomAction => new(_haContext, "sensor.switch_ikea_master_bedroom_action");
    ///<summary>switch_ikea_master_bedroom Click</summary>
    public SensorEntity SwitchIkeaMasterBedroomClick => new(_haContext, "sensor.switch_ikea_master_bedroom_click");
    ///<summary>blind_office Battery</summary>
    public NumericSensorEntity BlindOfficeBattery => new(_haContext, "sensor.blind_office_battery");
    ///<summary>blind_office Temperature</summary>
    ...
    ///<summary>greenCell Watch Battery</summary>
    public NumericSensorEntity GreencellWatchBattery => new(_haContext, "sensor.greencell_watch_battery");
    ...
    ///<summary>iPhone (Natalia) Watch Battery</summary>
    public NumericSensorEntity IphoneNataliaWatchBattery => new(_haContext, "sensor.iphone_natalia_watch_battery");
    ///<summary>light_sensor_outside Battery</summary>
    public NumericSensorEntity LightSensorOutsideBattery => new(_haContext, "sensor.light_sensor_outside_battery");
    ///<summary>light_sensor_outside Illuminance</summary>
    ...
    ///<summary>PrusaMK4 Print speed</summary>
    public NumericSensorEntity Prusamk4PrintSpeed2 => new(_haContext, "sensor.prusamk4_print_speed_2");
    ///<summary>PrusaMK4 Progress</summary>
    public NumericSensorEntity Prusamk4Progress2 => new(_haContext, "sensor.prusamk4_progress_2");
    ///<summary>switch_ikea_master_bedroom Battery</summary>
    public NumericSensorEntity SwitchIkeaMasterBedroomBattery => new(_haContext, "sensor.switch_ikea_master_bedroom_battery");
    ///<summary>temp_attic Battery</summary>
    public NumericSensorEntity TempAtticBattery => new(_haContext, "sensor.temp_attic_battery");
    ///<summary>temp_attic Humidity</summary>
    public NumericSensorEntity TempAtticHumidity => new(_haContext, "sensor.temp_attic_humidity");
    ///<summary>temp_attic Atmospheric pressure</summary>
    public NumericSensorEntity TempAtticPressure => new(_haContext, "sensor.temp_attic_pressure");
    ///<summary>temp_attic Temperature</summary>
    public NumericSensorEntity TempAtticTemperature => new(_haContext, "sensor.temp_attic_temperature");
    ///<summary>temp_bruno Battery</summary>
    public NumericSensorEntity TempBrunoBattery => new(_haContext, "sensor.temp_bruno_battery");
    ///<summary>temp_bruno Humidity</summary>
    public NumericSensorEntity TempBrunoHumidity => new(_haContext, "sensor.temp_bruno_humidity");
    ///<summary>temp_bruno Atmospheric pressure</summary>
    public NumericSensorEntity TempBrunoPressure => new(_haContext, "sensor.temp_bruno_pressure");
    ///<summary>temp_bruno Temperature</summary>
    public NumericSensorEntity TempBrunoTemperature => new(_haContext, "sensor.temp_bruno_temperature");
    ///<summary>temp_downstairs_bathroom Battery</summary>
    public NumericSensorEntity TempDownstairsBathroomBattery => new(_haContext, "sensor.temp_downstairs_bathroom_battery");
    ///<summary>temp_downstairs_bathroom Humidity</summary>
    public NumericSensorEntity TempDownstairsBathroomHumidity => new(_haContext, "sensor.temp_downstairs_bathroom_humidity");
    ///<summary>temp_downstairs_bathroom Atmospheric pressure</summary>
    public NumericSensorEntity TempDownstairsBathroomPressure => new(_haContext, "sensor.temp_downstairs_bathroom_pressure");
    ///<summary>temp_downstairs_bathroom Temperature</summary>
    public NumericSensorEntity TempDownstairsBathroomTemperature => new(_haContext, "sensor.temp_downstairs_bathroom_temperature");
    ///<summary>temp_garage Battery</summary>
    public NumericSensorEntity TempGarageBattery => new(_haContext, "sensor.temp_garage_battery");
    ///<summary>temp_garage_corridor Battery</summary>
    public NumericSensorEntity TempGarageCorridorBattery => new(_haContext, "sensor.temp_garage_corridor_battery");
    ///<summary>temp_garage_corridor Humidity</summary>
    public NumericSensorEntity TempGarageCorridorHumidity => new(_haContext, "sensor.temp_garage_corridor_humidity");
    ///<summary>temp_garage_corridor Atmospheric pressure</summary>
    public NumericSensorEntity TempGarageCorridorPressure => new(_haContext, "sensor.temp_garage_corridor_pressure");
    ///<summary>temp_garage_corridor Temperature</summary>
    public NumericSensorEntity TempGarageCorridorTemperature => new(_haContext, "sensor.temp_garage_corridor_temperature");
    ///<summary>temp_garage Humidity</summary>
    public NumericSensorEntity TempGarageHumidity => new(_haContext, "sensor.temp_garage_humidity");
    ///<summary>temp_garage Atmospheric pressure</summary>
    public NumericSensorEntity TempGaragePressure => new(_haContext, "sensor.temp_garage_pressure");
    ///<summary>temp_garage Temperature</summary>
    public NumericSensorEntity TempGarageTemperature => new(_haContext, "sensor.temp_garage_temperature");
    ///<summary>temp_kitchen Battery</summary>
    public NumericSensorEntity TempKitchenBattery => new(_haContext, "sensor.temp_kitchen_battery");
    ///<summary>temp_kitchen Humidity</summary>
    public NumericSensorEntity TempKitchenHumidity => new(_haContext, "sensor.temp_kitchen_humidity");
    ///<summary>temp_kitchen Atmospheric pressure</summary>
    public NumericSensorEntity TempKitchenPressure => new(_haContext, "sensor.temp_kitchen_pressure");
    ///<summary>temp_kitchen Temperature</summary>
    public NumericSensorEntity TempKitchenTemperature => new(_haContext, "sensor.temp_kitchen_temperature");
    ///<summary>temp_lila Battery</summary>
    public NumericSensorEntity TempLilaBattery => new(_haContext, "sensor.temp_lila_battery");
    ///<summary>temp_lila Humidity</summary>
    public NumericSensorEntity TempLilaHumidity => new(_haContext, "sensor.temp_lila_humidity");
    ///<summary>temp_lila Atmospheric pressure</summary>
    public NumericSensorEntity TempLilaPressure => new(_haContext, "sensor.temp_lila_pressure");
    ///<summary>temp_lila Temperature</summary>
    public NumericSensorEntity TempLilaTemperature => new(_haContext, "sensor.temp_lila_temperature");
    ///<summary>temp_living_room_corner_window Battery</summary>
    public NumericSensorEntity TempLivingRoomCornerWindowBattery => new(_haContext, "sensor.temp_living_room_corner_window_battery");
    ///<summary>temp_living_room_corner_window Humidity</summary>
    public NumericSensorEntity TempLivingRoomCornerWindowHumidity => new(_haContext, "sensor.temp_living_room_corner_window_humidity");
    ///<summary>temp_living_room_corner_window Atmospheric pressure</summary>
    public NumericSensorEntity TempLivingRoomCornerWindowPressure => new(_haContext, "sensor.temp_living_room_corner_window_pressure");
    ///<summary>temp_living_room_corner_window Temperature</summary>
    public NumericSensorEntity TempLivingRoomCornerWindowTemperature => new(_haContext, "sensor.temp_living_room_corner_window_temperature");
    ///<summary>temp_living_room_front_window Battery</summary>
    public NumericSensorEntity TempLivingRoomFrontWindowBattery => new(_haContext, "sensor.temp_living_room_front_window_battery");
    ///<summary>temp_living_room_front_window Humidity</summary>
    public NumericSensorEntity TempLivingRoomFrontWindowHumidity => new(_haContext, "sensor.temp_living_room_front_window_humidity");
    ///<summary>temp_living_room_front_window Atmospheric pressure</summary>
    public NumericSensorEntity TempLivingRoomFrontWindowPressure => new(_haContext, "sensor.temp_living_room_front_window_pressure");
    ///<summary>temp_living_room_front_window Temperature</summary>
    public NumericSensorEntity TempLivingRoomFrontWindowTemperature => new(_haContext, "sensor.temp_living_room_front_window_temperature");
    ///<summary>temp_master_bed Battery</summary>
    public NumericSensorEntity TempMasterBedBattery => new(_haContext, "sensor.temp_master_bed_battery");
    ///<summary>temp_master_bed Humidity</summary>
    public NumericSensorEntity TempMasterBedHumidity => new(_haContext, "sensor.temp_master_bed_humidity");
    ///<summary>temp_master_bed Atmospheric pressure</summary>
    public NumericSensorEntity TempMasterBedPressure => new(_haContext, "sensor.temp_master_bed_pressure");
    ///<summary>temp_master_bed Temperature</summary>
    public NumericSensorEntity TempMasterBedTemperature => new(_haContext, "sensor.temp_master_bed_temperature");
    ///<summary>temp_office Battery</summary>
    public NumericSensorEntity TempOfficeBattery => new(_haContext, "sensor.temp_office_battery");
    ///<summary>temp_office Humidity</summary>
    public NumericSensorEntity TempOfficeHumidity => new(_haContext, "sensor.temp_office_humidity");
    ///<summary>temp_office Atmospheric pressure</summary>
    public NumericSensorEntity TempOfficePressure => new(_haContext, "sensor.temp_office_pressure");
    ///<summary>temp_office Temperature</summary>
    public NumericSensorEntity TempOfficeTemperature => new(_haContext, "sensor.temp_office_temperature");
    ///<summary>temp_outside Battery</summary>
    public NumericSensorEntity TempOutsideBattery => new(_haContext, "sensor.temp_outside_battery");
    ///<summary>temp_outside Humidity</summary>
    public NumericSensorEntity TempOutsideHumidity => new(_haContext, "sensor.temp_outside_humidity");
    ///<summary>temp_outside Atmospheric pressure</summary>
    public NumericSensorEntity TempOutsidePressure => new(_haContext, "sensor.temp_outside_pressure");
    ///<summary>temp_outside Temperature</summary>
    public NumericSensorEntity TempOutsideTemperature => new(_haContext, "sensor.temp_outside_temperature");
    ///<summary>temp_upstairs_bathroom Battery</summary>
    public NumericSensorEntity TempUpstairsBathroomBattery => new(_haContext, "sensor.temp_upstairs_bathroom_battery");
    ///<summary>temp_upstairs_bathroom Humidity</summary>
    public NumericSensorEntity TempUpstairsBathroomHumidity => new(_haContext, "sensor.temp_upstairs_bathroom_humidity");
    ///<summary>temp_upstairs_bathroom Atmospheric pressure</summary>
    public NumericSensorEntity TempUpstairsBathroomPressure => new(_haContext, "sensor.temp_upstairs_bathroom_pressure");
    ///<summary>temp_upstairs_bathroom Temperature</summary>
    public NumericSensorEntity TempUpstairsBathroomTemperature => new(_haContext, "sensor.temp_upstairs_bathroom_temperature");
    ///<summary>temp_upstairs_corridor Battery</summary>
    public NumericSensorEntity TempUpstairsCorridorBattery => new(_haContext, "sensor.temp_upstairs_corridor_battery");
    ///<summary>temp_upstairs_corridor Humidity</summary>
    public NumericSensorEntity TempUpstairsCorridorHumidity => new(_haContext, "sensor.temp_upstairs_corridor_humidity");
    ///<summary>temp_upstairs_corridor Atmospheric pressure</summary>
    public NumericSensorEntity TempUpstairsCorridorPressure => new(_haContext, "sensor.temp_upstairs_corridor_pressure");
    ///<summary>temp_upstairs_corridor Temperature</summary>
    public NumericSensorEntity TempUpstairsCorridorTemperature => new(_haContext, "sensor.temp_upstairs_corridor_temperature");
    ///<summary>temp_utility_room Battery</summary>
    public NumericSensorEntity TempUtilityRoomBattery => new(_haContext, "sensor.temp_utility_room_battery");
    ///<summary>temp_utility_room Humidity</summary>
    public NumericSensorEntity TempUtilityRoomHumidity => new(_haContext, "sensor.temp_utility_room_humidity");
    ///<summary>temp_utility_room Atmospheric pressure</summary>
    public NumericSensorEntity TempUtilityRoomPressure => new(_haContext, "sensor.temp_utility_room_pressure");
    ///<summary>temp_utility_room Temperature</summary>
...
public partial class SwitchEntities
{
    ...
    ///<summary>Dryer ChildLock</summary>
    public SwitchEntity DryerChildlock => new(_haContext, "switch.dryer_childlock");
    ...
    ///<summary>office_heating_switch</summary>
    public SwitchEntity OfficeHeatingSwitch => new(_haContext, "switch.office_heating_switch");
...
public partial class UpdateEntities
{
    ...
    ///<summary>bulb_master_bed</summary>
    public UpdateEntity BulbMasterBed => new(_haContext, "update.bulb_master_bed");
    ...
    ///<summary>switch_ikea_master_bedroom</summary>
    public UpdateEntity SwitchIkeaMasterBedroom => new(_haContext, "update.switch_ikea_master_bedroom");
}
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>netdaemon_home_automations_net_daemon_apps_ender_ender</summary>
    public InputBooleanEntity NetdaemonHomeAutomationsNetDaemonAppsEnderEnder => new(_haContext, "input_boolean.netdaemon_home_automations_net_daemon_apps_ender_ender");
    ...
    ///<summary>netdaemon_home_automations_net_daemon_apps_morning_alarm_morning_alarm</summary>
    public InputBooleanEntity NetdaemonHomeAutomationsNetDaemonAppsMorningAlarmMorningAlarm => new(_haContext, "input_boolean.netdaemon_home_automations_net_daemon_apps_morning_alarm_morning_alarm");
...
public partial class ButtonEntities
{
    ...
    ///<summary>PrusaMK4 Cancel job</summary>
    public ButtonEntity Prusamk4CancelJob2 => new(_haContext, "button.prusamk4_cancel_job_2");
    ///<summary>PrusaMK4 Pause job</summary>
    public ButtonEntity Prusamk4PauseJob2 => new(_haContext, "button.prusamk4_pause_job_2");
    ///<summary>PrusaMK4 Resume job</summary>
    public ButtonEntity Prusamk4ResumeJob2 => new(_haContext, "button.prusamk4_resume_job_2");
}
...
public partial class CameraEntities
{
    ...
    ///<summary>PrusaMK4 Preview</summary>
    public CameraEntity Prusamk4Preview2 => new(_haContext, "camera.prusamk4_preview_2");
}
...
public partial class LightEntities
{
    ...
    ///<summary>bulb_master_bed</summary>
    public LightEntity BulbMasterBed => new(_haContext, "light.bulb_master_bed");
...
public partial class NetdaemonServices
{
    ...
    public void UpstairsFanService(object? data = null)
    {
        _haContext.CallService("netdaemon", "upstairs_fan_service", null, data);
    }
}
...
public partial class NotifyServices
{
    ...
    ///<summary>Sends a notification message using the mobile_app_titancell integration.</summary>
    public void MobileAppTitancell(NotifyMobileAppTitancellParameters data)
    {
        _haContext.CallService("notify", "mobile_app_titancell", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void MobileAppTitancell(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_titancell", null, new NotifyMobileAppTitancellParameters { Message = message, Title = title, Target = target, Data = data });
    }
...
public partial record NotifyMobileAppTitancellParameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
